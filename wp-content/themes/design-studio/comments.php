...
//Files in single-solutions.php file, theme-support.php (activated in functions.php), comment-nav.php
...
<div id="comments" class="comments-area">
	...
	?>
		...
		<h2 class="comment-title">
			<?php 
				printf(
					esc_html( _nx( 'One comment on &ldquo;%2$s&rdquo;', '%1$s comments on &ldquo;%2$s&rdquo;', get_comments_number(), 'comments title', 'design-studio' ) ),//&ldquo - left double quote, &rdquo - right double quote, %1$s - dynamic number
		...
		?>
				...
				<p class="no-comments"><?php esc_html_e( 'Comments are closed.', 'design-studio' ); //second parameter - text domain?></p>
