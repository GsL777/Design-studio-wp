...
<article id="post-<?php the_ID(); ?>" <?php post_class( array('design-format-standard') ); //array() - for declaring multiple classes, but if there is one class than array word could be deleted.?>>
