...
<form method="post" action="options.php" class="design-general-form">
	...
	<?php settings_fields( 'design-contact-options' ); //Contact Form Options from function design_custom_settings register_setting First parameter?>
	
	<?php do_settings_sections( 'design_website_theme_contact' ); //Contact Form Options from function design_custom_settings Fourth parameter?>
